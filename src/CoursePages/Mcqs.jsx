...
const MCQs = () => {
    ...
    return (
        <div className="flex flex-col w-full max-h-screen justify-between flex-auto">
        ...
        <div className='flex flex-col mobile:w-full tablet:w-full laptop:flex-row laptop:w-full laptop:justify-center'>
            ...
            <Window openPage= "mcqs" sideNavControl={sideNavControl} hideSideNav={hideSideNav}/>
            ...
            {hideSideNav && 
              ...
              <Sidenav handleSelectData={handleSelectData} handleChapterData={handleChapterData} subChapter = {selectData} chapter = {chapterData} hideSideNav={hideSideNav} sideNavControl={sideNavControl}/>
              </div>
            }
        </div>
        <hr/>
