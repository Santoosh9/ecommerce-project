...
const Notifications = () => {
  const notification = [
    ...
    },
    {
      ...
      description:
        'This is to notice all the students that their regular class for NEA 7th Level Full Course is resuming from tomorrow: 12/02/2023 from 9 to 12 AM  ',
        ...
        <div className="flex justify-between items-center w-full h-12 py-3  pl-4 pr-1 gap-4">
          <div className="w-1/2 h-3/5">
            <div className="flex w-3/4 h-full gap-2">
              <p className="w-fit h-[18px] font-medium text-sm leading-[18px]">
                Notifications
              </p>
              <div className="w-14 h-5 ">
                <div className="flex items-center h-full w-full gap-1">
                  <p className="w-11 h-full font-medium text-xs leading-5 text-[#2C272480]">
                    All
                  </p>
                ...
                <div className="w-full h-fit pb-2 relative">
                  ...
                  <div className="flex items-center justify-start w-full h-fit px-4">
                    <div className="flex justify-center items-center bg-[#006EB9] rounded-full w-8 h-8">
                      {onenotice.group === 'class' && (
                        <MdPeopleOutline className="text-white" />
                      )}
                      {onenotice.group === 'exam' && (
                        <CgFileDocument className="text-white" />
                      )}
                      {onenotice.group === 'alert' && (
                        <HiBell className="text-white" />
                      )}
                    </div>
                    <div className="w-[80%] h-fit gap-2.5 pl-2">
                      <p className="w-full h-fit font-semibold text-sm leading-[18px]">
                        {onenotice.header}
                      </p>
                    </div>
                  </div>
                  {onenotice.description && (
                    <div className="flex justify-start w-full h-fit pr-4 pl-16 gap-2.5">
                      ...
                      <div className="w-full h-fit gap-2">
                        <p className="w-full h-fit font-normal text-sm leading-5">
                          {onenotice.description}
                        </p>
                      </div>
                    </div>
