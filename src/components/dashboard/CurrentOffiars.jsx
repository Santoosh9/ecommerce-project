      ...
      <div className="w-[90%] h-fit rounded-2xl mx-auto my-10 border ">
        ...
        {isLoading && (
          <div className="flex w-full h-10 items-center justify-center px-3">
            ...
            <p className="mx-10 text-center font-medium text-base">
              Loading...
            </p>
          </div>
        )}
        {isError && (
          <div className="flex mx-10 w-full h-10 items-center justify-center font-medium text-base text-center text-red-600">
            {error.message}
          </div>
        )}
