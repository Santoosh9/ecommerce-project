...
const AddAnswer = (props) => {
    ...
    const { mutate: answersMutation, data:addedMessage } = addAnswersData();
    const { mutate: editAnswerMutation, data:editedMessage } = editAnswerData();
    ...
    const handleAddAnswer = async (e, forumid) => {
        ...
        try {
            ...
            props.getNewAnswer(addedMessage.data.response.answerid)
    ...
    const handleEditAnswer = async (e, editData) => {
        ...
        try {
            ...
            props.getNewAnswer(editedMessage.data.response.answerid)
            handleCancel();
        } catch (error) {
            toast.error(error.message)
        }
