        ...
        <div className="flex justify-center w-full h-220px tablet:h-[440px] border border-blue-200">
            ...
            <div className="flex flex-col justify-between items-center w-320px h-220px tablet:w-780px tablet:h-playwindow laptop:w-playwindow laptop:h-playwindow">
                ...
                <div className="flex justify-center items-center w-6 h-6">
                    <div className="flex justify-center items-center w-6 h-6">
                        {props.hideSideNav ? 
                        <TfiAngleRight className="text-white"/> : <TfiAngleLeft className="text-white"/>  }
                    </div>
                </div>
            </div>
            </div>
            ...
            <div className="w-full h-full mt-4 ml-4 mr-4 tablet:mt-9 tablet:ml-28 tablet:mr-28 gap-10">
                ...
                <div className="flex justify-between w-full h-4 m-4 laptop:gap-96">
                    <div className="flex justify-center items-center w-24 h-4 gap-2" onClick={ () => handleChangeQue(0)}>
                        ...
                        <p className="text-sm font-medium tracking-normal text-center text-blue-500 cursor-pointer">Previous</p>
                    </div>
                    { !mcqDone ? 
                    <div className="flex justify-center items-center w-24 h-4 gap-2" onClick={ ()=> handleChangeQue(1)}>
                        <p className="text-sm font-medium tracking-normal text-center text-blue-500 cursor-pointer">Next</p>
                    ...
                    <Link to='/learning/complete'> 
                        <div className="flex justify-center items-center w-24 h-4 gap-2">
                            <p className="text-sm font-medium tracking-normal text-center text-blue-500">Next</p>
                            <div className="flex justify-center items-center w-4 h-4 z-0" >
                                <TfiAngleRight className="text-blue-700"/>
                            </div>
                        </div>
            ...
            <div className="flex flex-col justify-center items-center w-full laptop:w-playwindow h-full gap-10">
                    <div className="w-full h-fit gap-2">
                        <div className="flex flex-col justify-center items-center w-full h-28 gap-4">
                            ...
                            <p className="w-full tablet:w-3/5 h-16 text-sm font-normal leading-5 tracking-normal text-center">Congratulations on completing your exam! Embrace this achievement, cherish the knowledge you've gained, and keep striving for excellence.</p>
                        </div>
