...
const IntroCourse = () => {
    return (
        <div className="flex flex-col-reverse laptop:flex-row w-[90%] h-[408px] mt-32 ml-6 tablet:mt-60 laptop:mt-20 tablet:ml-32 gap-6 laptop:gap-24 border-b border-b-[#E1ECF3]">
