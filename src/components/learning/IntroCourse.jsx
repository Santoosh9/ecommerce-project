                ...
                <div className="w-full h-[272px] gap:4 tablet:gap-16">
                    <div className="flex flex-col justify-between w-full h-[272px] gap-2 tablet:gap-6">
                        <div className="flex flex-col w-full h-fit gap-1 tablet:gap-4">
                            ...
                            <p className="w-[90%] h-fit laptop:h-24 font-medium text-4xl leading-[48px] text-black py-2">Rastriya Banijya Bank (RBB) 4th Level Full Course</p>
                            ...
                            <p className="w-[80%] laptop:w-full h-fit font-normal text-base leading-6 text-[#2C2724BF] py-3">Access a vast array of courses, by a very interactive lessons, and expert also by giving a full course. Access a vast array of courses, by a very interactive lessons.</p>
                        </div>
                        ...
                        <div className="w-fit h-12 gap-4 py-2">
                            <Link to='/payment'>
                            <button className="flex w-fit h-12 mt-6 px-8 py-4 bg-[#006EB9] text-white text-center items-center">Enroll Now</button>
                            </Link>
                        </div> 
                    </div>
                </div>
