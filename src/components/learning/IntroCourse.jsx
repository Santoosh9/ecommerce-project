                ...
                <div className="w-full h-[272px] gap:4 tablet:gap-16">
                    <div className="flex flex-col justify-between w-full h-[272px] gap-2 tablet:gap-6">
                        <div className="flex flex-col w-full h-fit gap-1 tablet:gap-4">
                            ...
                            <p className="w-full h-fit font-normal text-base leading-6 text-[#2C2724BF]">Access a vast array of courses, by a very interactive lessons, and expert also by giving a full course. Access a vast array of courses, by a very interactive lessons.</p>
                        </div>
