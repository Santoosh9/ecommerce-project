...
const Map = () => {
  return (
    <>
      <div className="flex flex-col w-[100%] gap-0 mb-0 ">
        <div className="flex flex-col items-center">
          <p className="mt-4 text-blue-400  font-Poppins">Features</p>

          <div className="  text-black  text-3xl mt-4  w-[600px]">
            Elevate your learning experience
          </div>

          <div className="mt-4 w-[670px]">
            <p className="font-Poppins  w-full inline-block ">
          ...
          <div className=" flex flex-row  flex-wrap   justify-center gap-10 mb-8">
            <div className="flex flex-col mt-16 drop-shadow-md border border-sky-100 h-[200px] w-[200px]">
              <img
                ...
                src="./images/i2.png"
              />
              <p className="mt-4 text-lg  ml-6 font-Poppins">
                20k hours of Videos
              </p>
            </div>
            <div className="flex flex-col mt-16 drop-shadow-md border border-sky-100 h-[200px] w-[200px]">
            ...
            <div className="flex flex-col mt-16 drop-shadow-md border border-sky-100 h-[200px] w-[200px] ">
              <img
                ...
                src="./images/i4.png "
              />
              <p className="mt-4 text-lg  ml-6 font-Poppins">Free MCQ Exams</p>
            </div>
          </div>
        </div>

        <div className="w-[100%] h-[366px] ">
          <iframe
            className=" mt-4 "
